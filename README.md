# Global Credit Protocol

Global Credit Protocol is a decentralized finance platform that solves capital inefficiency due to over-collateralization. By uniting decentralized identity, on-chain credit scores, and dynamic risk premiums, we allow trusted users to borrow _more_ with _less_ collateral, while keeping the protocol 100% secure.

## The 2-Minute Pitch & Page Workflow

### Introduction (The Hook - 15 Seconds)

"Welcome to the Global Credit Protocol. We are solving one of the biggest problems in DeFi today: capital inefficiency due to over-collateralization. By uniting decentralized identity, on-chain credit scores, and dynamic risk premiums, we allow trusted users to borrow _more_ with _less_ collateral, while keeping the protocol 100% secure. Let me walk you through our platform."
